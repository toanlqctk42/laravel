...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="{{ asset('/') }}backEndSource/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
...
<body class="hold-transition login-page">
    <div class="login-box">
        <!-- /.login-logo -->
        @if (Session::has('sms'))
        <p class="alert {{ Session::get('alert-class', 'alert-info') }}">{{ Session::get('sms') }}</p>
        @endif
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="{{-- {{ route('home_front') }} --}}" class="h1"><b>Da Lat </b>View</a>
            </div>
            <div class="card-body">
    ...
    <!-- AdminLTE App -->
    <script src="{{ asset('/') }}backEndSource/dist/js/adminlte.min.js"></script>
</body>
